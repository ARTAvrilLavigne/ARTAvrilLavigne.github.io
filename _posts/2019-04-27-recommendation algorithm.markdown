...
1、**对于基于内容的推荐，这是比较老旧的推荐方法，但是对于系统和结构比较好的内容，则低成本且高效。**  
2、**对于基于内容的协同过滤，就适用于内容比较有限，但是用户数特别多的情况，例如电商公司。**  
3、**对于基于用户的协同过滤，则比较容易根据用户的兴趣点，发觉热点内容，例如新闻门户。**  
4、**对于基于标签的推荐，有标签系统的很占便宜，它在灵活性和可控制性上都好一些，但是做好很难。** 
