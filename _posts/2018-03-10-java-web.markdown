...
---
## 一、什么是Ognl？<br>
<p>　　　　　　通过百度百科查询到的解释，其中详细的说明了OGNL的作用。</p>
<p>　　　　　　　　　　<img src="https://images2015.cnblogs.com/blog/874710/201703/874710-20170322133324518-645486244.png" alt="" width="678" height="113"></p>
...
<p>　　　　　　　　　<span style="font-size: 16px">ActionContext</span>：</p>
...
<p>　　　　　　　　　　　　　　　　　　set存放，通过属性也可以直接获得。这里要排除一个误区，就是不要觉得set方式是以键值对的方式存放，就觉得是放入了context中，并没有，还是在root中锝</p>
<p>　　　　　　　　　　　　　　context操作</p>
